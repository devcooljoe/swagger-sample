...
<body data-new-gr-c-s-loaded="14.1104.0">
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="360" align="left">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td align="left" class="esd-block-text" spellcheck="false" data-ms-editor="true">
                                                                <p>Hello&nbsp;{{ $user->name  }},<br></p>
                                                                <p>Your verification code is <span style="font-size:16px;"><strong>{{ $code }}</strong></span></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
